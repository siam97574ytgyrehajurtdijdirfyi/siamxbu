...
setInterval(function () {
    ...
    if (liveText) {
        liveText.innerHTML = "LIVE";         // "LIVE" লেখা সেট করা
        liveText.style.color = "#0faf59";     // সবুজ রঙ (#0faf59)
        liveText.style.fontWeight = "bold";   // Bold ফন্ট
        liveText.style.fontSize = "10px";     // ফন্ট সাইজ ঠিক করা (10px)
    }
}, 500);
